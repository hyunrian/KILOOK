...
<script>
	...
	$(document).ready(function() {
		...
		$("#likeHeart").click(function(){
			...
			var url = "";
			if(likeResult == "true"){
				url = "/like/deletePlaceLike/${getPlaceInfo.bno}";
			} else {
				url = "/like/addPlaceLike/${getPlaceInfo.bno}";
			}
	...
	function hasChildReply(rno) {
		$.get("/reply/checkChildPlaceReply/" + rno, function(hasReply) {
			if (hasReply == "true") {
				return true;
			} else {
				return false;
...
// 		debugger;
	...
	function insertReply(replyObject) {
			...
			if (replyObject != "") {
				...
				$.post("/reply/placeInsert", sData, function(rData) {
					getReplyList();
				});
			}
		} 
				...
				<div class="row">
					<div class="col-md-12 ftco-animate">
						<div class="single-slider owl-carousel">
							<div class="item">
								<div class="hotel-img"
									style="background-image: url('${getPlaceInfo.image}');"></div>
							</div>
							<div class="item">
								<div class="hotel-img"
									style="background-image: url('${getPlaceInfo.thumbimage}');"></div>
							</div>
						</div>
					</div>
					<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
						...
						<p class="rate mb-5">
							...
							<br>
							<span>
								전화번호:&nbsp;&nbsp;${getPlaceInfo.anumber}
							</span>
							<br>
							<span>
								오픈시간:&nbsp;&nbsp;${getPlaceInfo.openhours}
							</span>
							<br>
							<span>
								가격:&nbsp;&nbsp;${getPlaceInfo.price}
							</span>
							<br>
							<span>
